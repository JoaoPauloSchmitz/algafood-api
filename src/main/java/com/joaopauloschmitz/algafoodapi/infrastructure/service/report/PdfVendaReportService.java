package com.joaopauloschmitz.algafoodapi.infrastructure.service.report;
...
public class PdfVendaReportService implements VendaReportService {
    ...
    public byte[] emitirVendasDiarias(VendaDiariaFilter vendaDiariaFilter, String timeOffset) {
        try {
            ...
            var vendasDiarias = this.vendaQueryService.consultarVendasDiarias(vendaDiariaFilter, timeOffset);
